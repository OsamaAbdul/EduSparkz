...
//   // Detect mobile screen size using react-responsive
...
//   return (
//     <DashboardLayout>
//       {/* Sidebar: Hidden on mobile, otherwise conditional */}
//       {!isMobile && (
//         <div
//           className={`sticky top-0 h-screen ${
//             sidebarOpen ? "block w-64" : "hidden md:block md:w-16"
//           }`}
//         >
//           {loading ? (
...
//                 </Card>
//               ) : (
//                 // Skeleton for FileUploadCard (non-mobile)
...
export const Dashboard = () => {
  ...
  const toggleSidebar = () => {
    ...
    console.log("Sidebar toggled, new state:", !sidebarOpen); // Debug log
  };
