    ...
    <section className="relative z-10 px-6 py-20 text-center">
      <div className={`max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
          Are you a student of a College, University, Polytehnic or a learner who wants to strive academically, this is for 
          you. Upload any studies materials e.g PDF, DOCX, IMAGE and get a mind-blowing quiz generated personally for you from the materials you uploaded.
        </p>
