...
export const FAQSection = () => {
  const faqs = [
    {
      question: "How accurate is the AI-generated quiz content?",
      answer: "Our AI uses advanced language models (OpenAI GPT and Google Gemini) to ensure high accuracy. The system analyzes your PDF content contextually and generates relevant questions with 95%+ accuracy rate."
    },
    {
      question: "What file formats are supported for upload?",
      answer: "Currently, we support PDF files up to 10MB in size. We're working on adding support for Word documents, PowerPoint presentations, and other common educational formats."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes! You can set difficulty levels (beginner, intermediate, advanced) and specify the number of questions. The AI adapts the complexity based on your preferences."
    },
    {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">
            Everything you need to know about AI Quiz Generator
          </p>
        </div>
