...
export const FeaturesSection = () => {
  const features = [
    ...
    },
    {
      icon: Target,
      title: "Motivation",
      description: "Get motivational quotes based on user performance",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Everything you need to create, take, and evaluate quizzes with the power of artificial intelligence(AI)
          </p>
        </div>
